  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // Rich gray scale for enhanced hierarchy
        gray: {
        ...
        // Enhanced accent colors for emphasis
        "accent-blue": {
          DEFAULT: "hsl(var(--accent-blue) / <alpha-value>)",
          foreground: "hsl(var(--accent-blue-foreground) / <alpha-value>)",
        },
        "accent-emerald": {
          DEFAULT: "hsl(var(--accent-emerald) / <alpha-value>)",
          foreground: "hsl(var(--accent-emerald-foreground) / <alpha-value>)",
        },
        "accent-amber": {
          DEFAULT: "hsl(var(--accent-amber) / <alpha-value>)",
          foreground: "hsl(var(--accent-amber-foreground) / <alpha-value>)",
        },
        "accent-rose": {
          DEFAULT: "hsl(var(--accent-rose) / <alpha-value>)",
          foreground: "hsl(var(--accent-rose-foreground) / <alpha-value>)",
        },
        // Extended surface colors for better layering
        surface: {
